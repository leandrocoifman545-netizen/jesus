    ...
    hook: {
      ...
      properties: {
        ...
        type: {
          ...
          // Active (formula-aligned) + legacy types
          enum: [
            // Active — 15 formulas
            "auto_seleccion_memoria", "eliminacion_barreras", "promesa_directa",
            "pregunta_espejo", "incredulidad_posesiva", "hipotetico_personal",
            "flip_contraintuitivo", "nadie_explica", "ataque_herramienta",
            "ancla_precio_invertida", "historia_dolor_sensorial", "voz_tercero",
            "timeline_proyeccion", "nombrar_innombrado", "provocacion_dato",
            // Legacy
            ...
            "simplificacion_error", "pregunta_limitacion", "asimetria_temporal",
