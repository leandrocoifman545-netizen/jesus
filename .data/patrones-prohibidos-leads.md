...
- **Ancla Precio Invertida** ("$X te debería cobrar por esto. Pero hoy te lo doy gratis.") — establece valor percibido ANTES de revelar gratuidad. El orden precio→gratis es clave. CLR 3.45 en @ramiro.cubria (su #1). Ideal para orgánico con lead magnet. Adaptación ADP: "Si te dijera que este checklist vale más que cualquier curso de $500... ¿me creerías?"
- **Incredulidad Posesiva** ("No entiendo cómo todavía no tenés/sabés [recurso/conocimiento].") — presión social sin agresión directa. Implica que la situación actual del viewer es la anomalía, no la norma. CLR 3.14 en Ramiro. Adaptación ADP: "No entiendo cómo todavía no sabés cuánto vale lo que ya sabés."
- **Condición Invertida de Identidad** ("No soy [referente aspiracional], pero [resultado comparable].") — se descalifica y re-califica en la misma oración. Anti-hype natural. CLR 3.14 + 247K views en Ramiro. Adaptación ADP: "No soy un gurú de Silicon Valley, pero facturo más de 100 mil dólares al año vendiendo lo que sé."
- **Ataque a la Herramienta** ("No vuelvas a [acción] con [herramienta popular] porque [es horrible].") — NO ataca al espectador ni a una persona. Ataca la HERRAMIENTA que el avatar usa. Genera curiosidad sin activar defensa. CLR 2.55 en Ramiro. Adaptación ADP: "Dejá de buscar 'cómo ganar plata online' en Google. Todo lo que vas a encontrar es basura."
- **Reframe de Costo (Enemigo-Recurso)** ("¿Para qué vas a gastar [plata/esfuerzo] en X si podés [aprovechar] Y?") — convierte el obstáculo en recurso. CLR 2.38 en Ramiro. Adaptación ADP: "¿Para qué vas a invertir meses aprendiendo de cero si podés empaquetar algo que ya sabés y venderlo esta semana?"
