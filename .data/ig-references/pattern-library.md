...
## Patrones de APERTURA (0-8s) × Performance

Qué tipo de hook genera más CLR y más views.
...
1. **@ramiro.cubria** (CLR 345.19%, 130,079 views)
   ...
   Patrones: dato_numero, ancla_precio_invertida | 9.44s

2. **@ramiro.cubria** (CLR 329.67%, 12,775 views)
   > Todos los dueños de negocio necesitan tener acceso al coach de 100 millones de dólares de Alex Hormozy. Esto es una puta locura. Tiene toda la información gratuita de Alex Hormozy cargada en su cerebro y te responde como si fuera él.
   Patrones: dato_numero, credencial | 10.9s

3. **@ramiro.cubria** (CLR 316.56%, 3,486 views)
   > Este video lo borro en 24 horas. Todo el mundo conoce los famosos libros de Alex Hormozy. Ahora, lo que nadie sabe es que hay una colección de 12 libros privada
   Patrones: provocacion | 8.98s

4. **@ramiro.cubria** (CLR 314.37%, 14,304 views)
   > No entiendo cómo todavía no tenés acceso a este documento. 4 prompts de chat GPT para hacer 30 mil dólares por mes. Es una puta locura. Antes de que te lo muestre, este documento solo lo compartí con clientes privados
   Patrones: dato_numero, incredulidad | 10s
...
6. **@ramiro.cubria** (CLR 293.37%, 6,528 views)
   ...
   Patrones: dato_numero, segunda_persona | 8.06s

7. **@ramiro.cubria** (CLR 288.77%, 3,751 views)
   > Esta plataforma de inteligencia artificial te permite hacer tu propio clon para grabar reels que se ven 100% reales, que se escuchan perfecto y lo mejor de todo, que los podes usar tanto para reels como para anuncios para atraer miles de potenciales clientes.
   Patrones: dato_numero | 12.08s

8. **@ramiro.cubria** (CLR 286.07%, 282,594 views)
   > ¿Es difícil clonarse con inteligencia artificial? La verdad que no. Genuinamente es una pelotudez. De hecho, yo no soy real. Soy un clon. Lo único que tenés que hacer es entrar al software de clonación,
   Patrones: pregunta, provocacion | 10.18s

9. **@ramiro.cubria** (CLR 276.52%, 11,655 views)
   > Se acaba de filtrar esta base de datos con 15.286 agentes de inteligencia artificial que automatizan todas las tareas de tu negocio.
   Patrones: exclusividad | 8.76s

10. **@ramiro.cubria** (CLR 275.68%, 9,145 views)
   > Se acaba de filtrar esta Wikipedia secreta con más de 1500 agentes de inteligencia artificial que te automatizan todas las tareas de tu negocio. Así es, es un repositorio con más de 1500 agentes de IA
   Patrones: exclusividad | 10.6s

11. **@ramiro.cubria** (CLR 272.34%, 4,348 views)
   > Este video lo borro en 24 horas. Se acaba de filtrar este nuevo agente de inteligencia artificial que es una puta locura. ¿Qué hace? Escribe carruseles ganadores que generan miles de comentarios.
   Patrones: exclusividad | 11.2s

12. **@ramiro.cubria** (CLR 271.05%, 65,095 views)
   > Me acabo de comprar este bolso nuevo de Louis Vuitton y me salió demasiado caro. ¿Por qué me lo compré? Por un momento de impulsividad. Ahora, hay algo adentro de este bolso que importa muchísimo más que la mierda esta.
   Patrones: provocacion | 11.82s

13. **@ramiro.cubria** (CLR 263.15%, 147,297 views)
   > Se acaba de filtrar esta base de datos de más de 2.000 agentes de inteligencia artificial que te resuelven todas las tareas de tu negocio. Y no, no es clickbait.
   Patrones: exclusividad | 8.02s

14. **@ramiro.cubria** (CLR 260.72%, 8,245 views)
   > ¿Cómo arreglar tu cuenta de Instagram en 30 segundos? Paso 1. Saca una captura de pantalla de tu perfil. Paso 2. Arrastra y solta la captura en chat GPT.
   Patrones: pregunta | 8.16s

15. **@ramiro.cubria** (CLR 257.4%, 8,119 views)
   > Estos carruseles hechos con inteligencia artificial están explotando Instagram. Son carruseles que se hacen literalmente en 5 minutos, súper fáciles,
   Patrones: neutro | 8.26s

16. **@ramiro.cubria** (CLR 254.68%, 13,397 views)
   > No vuelvas a escribir tus guiones con el chat GPT porque son una mierrrrrrr. Chat GPT es una mierda y los guiones suenan genéricos.
   Patrones: imperativo, provocacion | 8.72s

17. **@ramiro.cubria** (CLR 251.39%, 8,644 views)
   > ¡Mil dólares! Es lo que te debería cobrar por pasarte mi GPT customizado para hacer guiones. Con ese GPT vas a poder crear hasta 100 guiones en solo dos horas.
   Patrones: neutro | 9.58s

18. **@ramiro.cubria** (CLR 244.33%, 4,915 views)
   > Ya no tenés más excusa para grabar contenido. Estoy en mi cama en este momento y vos me estás viendo como si fuera un estudio profesional con una cámara profesional con un setup profesional para grabar.
   Patrones: neutro | 10.4s

19. **@ramiro.cubria** (CLR 241.3%, 6,657 views)
   > Le pagué 24 mil dólares a Alex Hormozy y desarrollé esta guía que te responde exactamente igual a él. Tiene toda la información gratuita que hay de él en internet y además tiene todo lo que aprendí trabajando con él por 24 mil dólares.
   Patrones: dato_numero | 11.24s

20. **@ramiro.cubria** (CLR 238.76%, 26,022 views)
   > Cualquier pelotudo que tenga entre mil y cinco mil seguidores puede hacer 30 mil dólares por mes en ventas. Apestosamente rico, me dicen el 2025.
   Patrones: dato_numero, provocacion | 8.2s

21. **@herasmedia** (CLR 191.13%, 1,533 views)
   > Voy a hacer que este desconocido gane 100.000 seguidores y 100.000 euros en 30 días haciendo OnlyFans para hombres. Perdón, mentira.
   Patrones: dato_numero, provocacion, credencial, acumulacion | 8.7s
...
## Patrones de CUERPO × Performance

Qué estructura narrativa correlaciona con engagement.
...
## Patrones de CIERRE (últimos 15s) × Performance

Cómo llegan al CTA y qué buildup funciona mejor.
...
1. **@ramiro.cubria** (CLR 345.19%, 130,079 views)
   Buildup (promesa_valor, 7.52s): "¿Por qué de nicho? Porque el contenido viral atrae seguidores pobres. Por eso necesitas este prompt para armar tu propio calendario de contenido de ni"
   CTA: "Comenta tres acá abajo en este video y te llegan los tres en menos de un minuto por mensaje privado."

2. **@ramiro.cubria** (CLR 329.67%, 12,775 views)
   Buildup (directo, 0s): ""
   CTA: "Así que si lo querés probar por tu cuenta solamente comenta 100M acá abajo y te envío el coach de 10"

3. **@ramiro.cubria** (CLR 316.56%, 3,486 views)
   Buildup (directo, 5.88s): "de los 12 libros de la colección oculta de Hormousy y de su círculo privado. Cuando se terminen las 24 horas, borro este video a la mierda."
   CTA: "Comenta Hormousy y te mando el PDF de 20 páginas con toda la información de la colección privada de "

4. **@ramiro.cubria** (CLR 314.37%, 14,304 views)
   Buildup (directo, 6.66s): "Te devuelve guiones completos para copiar y pegar con la estructura ganadora. Estos guiones que sacas son una máquina de generar consultas de clientes"
   CTA: "Así que si querés todo el documento con los cuatro prompts, solamente comenta cuatro y te envío el d"

5. **@ramiro.cubria** (CLR 314.21%, 247,504 views)
   Buildup (directo, 0s): ""
   CTA: "Lo único que tenés que hacer es comentar IA y te voy a mandar el prompt exacto para que copies, lo p"

6. **@ramiro.cubria** (CLR 288.77%, 3,751 views)
   Buildup (simplificacion, 5.9s): "Simplemente con un video tuyo de 10 minutos ya podés tener el clon entrenado que habla igual que vos y que gesticula igual que vos."
   CTA: "Si querés tener acceso a la plataforma de inteligencia artificial solamente comenta IA y te lo envío"

7. **@ramiro.cubria** (CLR 286.07%, 282,594 views)
   Buildup (promesa_valor, 12.2s): "que me generan todos los días miles de conversaciones con potenciales clientes calificados. Pero podés usarlo para lo que quieras. Reels, anuncios, cu"
   CTA: "Comenta Matrix y te lo mando en menos de un minuto"

8. **@ramiro.cubria** (CLR 276.52%, 11,655 views)
   Buildup (directo, 5.92s): "tener acceso a estos 15.000 agentes de inteligencia artificial que son increíbles, solamente"
   CTA: "tenés que comentar IA y yo te voy a mandar por privado el repositorio entero de agentes y un manual "

9. **@ramiro.cubria** (CLR 275.68%, 9,145 views)
   Buildup (directo, 4.26s): "que tiene todos los agentes de inteligencia artificial que necesita tu negocio para poder prosperar. ¿Quieres acceso?"
   CTA: "Lo único que tienes que hacer es comentar agente en este video y te voy a mandar todo el repositorio"

10. **@ramiro.cubria** (CLR 272.34%, 4,348 views)
   Buildup (directo, 5.92s): "El agente es una puta locura y por no implementarlo en tu cuenta de Instagram estás perdiendo decenas de miles de dólares por semana."
   CTA: "Y si la querés probar lo único que tenés que hacer es comentar IA y te la envío por mensaje privado "

11. **@herasmedia** (CLR 191.13%, 1,533 views)
   Buildup (directo, 0s): ""
   CTA: "Si quieres ver el método completo para aplicarlo para tu cuenta de Instagram y seguir el proceso de "

12. **@herasmedia** (CLR 175.36%, 147,504 views)
   Buildup (directo, 9.64s): "Vamos a hacer una cosa. Para toda la gente que comente viral en este vídeo, voy a enviarles una clase privada en la que explico cómo creé esos vídeos "
   CTA: "Simplemente comentar viral en este vídeo. Comentar viral y os lo mando. Perfecto."

13. **@herasmedia** (CLR 156.98%, 137,921 views)
   Buildup (directo, 7.18s): "sube mucho las visitas ¿usar ganchos? es lo que más sube las visitas pero hay una lista más de 21 cosas que te bajan las visitas"
   CTA: "y si comentas aquí lista te la mando para que hagas contenido y las visitas no bajen sino que suban "

14. **@herasmedia** (CLR 136.86%, 25,785 views)
   Buildup (directo, 1.98s): "¿Y esa estructura me la vas a enseñar o te la vas a quedar para ti?"
   CTA: "Tranquilo, si comentas guión en este vídeo te envío la estructura exacta para tu nicho en concreto p"

15. **@herasmedia** (CLR 128.63%, 22,874 views)
   Buildup (directo, 0s): ""
...
1. **Al generar hooks para ADP:** Consultar la tabla de aperturas. Los patrones con mejor CLR SON los que debemos priorizar.
2. **Al elegir estructura de cuerpo:** Los patrones de cuerpo con mejor CLR indican qué beats emocionales resuenan más.
3. **Al diseñar el cierre:** La combinación CTA doble (video + caption) con buildup de promesa_valor o remocion_riesgo domina.
4. **Para evitar patrones agotados:** Si un patrón tiene muchos usos pero CLR decayendo, está saturado.
5. **Para encontrar combos ganadores:** Cruzar apertura × cierre en pattern-library.json campo winning_combos.
